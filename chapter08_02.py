...
def update_image():
    ...
    # image_path = image_files[current_index] (보통 사용하는 코드지만 상위폴더의 이미지 불러옴)
    ...
    #일정 시간이 지나면 다시 update_image 실행 # 0 1 2 3 4%4=0 1 2 3 반복
...
image_files = ["kitten01.jpeg", "kitten02.jpeg", "cat01.jpeg", "cat02.jpeg"]
